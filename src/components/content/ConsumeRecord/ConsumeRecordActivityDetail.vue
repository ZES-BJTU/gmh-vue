      ...
      <el-col :xs="24" :sm="18" :md="12">
        <el-form class="new-form" :model="modActivity" ref="modActivity" label-width="120px" 
          ...
          <el-form-item label="绩效">
            <el-select v-model="modActivity.percents" multiple  placeholder="请输入绩效" filterable>
  ...
  methods: {
    onSubmit(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          if(this.modActivity.employeeIds.length != this.modActivity.employeeIds.length){
