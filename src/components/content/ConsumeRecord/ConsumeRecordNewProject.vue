    ...
    <el-row type="flex" justify="start">
      <el-col :xs="24" :sm="18" :md="12">
        <el-form class="new-form" :model="newProject" ref="newProject" label-width="120px" 
          ...
          <!-- 验证码 -->
          <el-form-item label="验证码" v-if="newProject.couponAmount > 1">
            <el-input v-model="newProject.validStr" placeholder="请出入验证码"></el-input>
          </el-form-item>
          ...
          <el-form-item label="绩效">
            <el-input v-model.trim="newProject.percents" placeholder="请输入数字,用英文逗号分隔"></el-input>
          </el-form-item>
