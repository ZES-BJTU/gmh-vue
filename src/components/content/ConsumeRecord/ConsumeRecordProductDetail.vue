      ...
      <el-col :xs="24" :sm="18" :md="12">
        <el-form class="new-form" :model="modProduct" ref="modProduct" label-width="120px" 
          ...
          <el-form-item label="绩效">
            <el-input v-model.trim="modProduct.percents" placeholder="请输入数字,用英文逗号分隔"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleCardContentSelect(val){// 切换会员卡
      ...
      this.card.productDiscount = Number.parseInt(card.productDiscount*100);
    ...
    handleCardCouponSelect(val){// 切换会员卡
      ...
      this.cardCoupon.productDiscount = Number.parseInt(card.productDiscount*100);
